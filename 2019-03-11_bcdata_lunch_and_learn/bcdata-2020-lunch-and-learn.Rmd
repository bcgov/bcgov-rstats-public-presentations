...
.large.right-title[
<br><br><br>
Sam Albers<small><sup>1</sup></small> 

Stephanie Hazlitt<small><sup>1</sup></small>

Andy Teucher<small><sup>2</sup></small>
...
.footnote-right[
<br><br>
1: Ministry of Citizens' Services

2: Ministry of Environment & Climate Change Strategy
...
# What happens when a decision is audited?
...
---
background-image: url(img/mladanot.png)
...
---
background-image: url(img/mlada.png)

---
class: middle, inverse

background-image: url(https://i.stack.imgur.com/c7bFc.jpg)
...
## `Can't write your Data Acquisition step in code` 
...
big_projects %>% 
  ...
  labs(title = "Major Projects in British Columbia", y = "Cost  in Millions", x = "Construction Type") +
  geom_col() +
  coord_flip() +
